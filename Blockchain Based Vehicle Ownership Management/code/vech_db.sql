...
(2,3,'34545','54535353','dvdxdd','54675546755');
...
insert  into `bank`(`bank_id`,`login_id`,`name`,`place`,`phone`,`email`) values 
(1,7,'bank','asdsds','3333333','adasdsd'),
(2,10,'gfjhf','ddds','06789368498','kstores@gmail.com');
...
insert  into `company`(`company_id`,`login_id`,`shopname`,`place`,`phone`,`email`) values 
(1,1,'kstores','kochi','06789368498','benjames@gmail.com');
...
insert  into `insurancecompany`(`insurance_id`,`login_id`,`name`,`place`,`phone`,`email`) values 
(1,6,'joo','dasfesd','asaas','asaS'),
(2,9,'sdfghjk dfghjkl','kochi','02345678906','sdfghjkl@ghj');
...
insert  into `loanrequest`(`loanrequest_id`,`allotvehicle_id`,`bank_id`,`details`,`date`,`status`) values 
(1,2,1,'zsdfdsfd','2025-03-04','paid');
...
(1,5,'sam','dfsd','234567','dasdzssaz'),
(2,8,'komal thatal','ddds','02345678905','kstores@gmail.com');
...
(1,4,'jithu','gf','angamaly','09767875459','jith23@gmail.com');
